...
high_plus_res = ["deu_Latn", "spa_Latn", "fra_Latn"]
...
for lang in low_res:
    ...
    tmp_config = {
        ...
        "train_file": "/coc/pskynet6/ychen3411/project03_ace_event/few-shot-learning-main/masakhane-ner/NLLB/easyproject_conll/output-nllb_3Bft_parallel/nllb_3Bft_parallel-en-{}-marker.json".format(
            lang.split("_")[0]
        ),
