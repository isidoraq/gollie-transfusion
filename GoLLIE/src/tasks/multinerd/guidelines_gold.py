...
EXAMPLES = {
    ...
    "multinerd_organization_examples": {
        "en": [
            "European Union",
            "BBC",
            "Boston Red Sox",
    ...
    "multinerd_mythological_examples": {
        "en": [
            "Thomas Aquinas",
            "Zeus",
            "Satan",
