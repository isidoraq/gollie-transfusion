GUIDELINES = {
    ...
    "redfm_placeofbirth": {
        "en": [
            "Place of Birth relation: most specific known (e.g., city instead of country, or\n"
            " hospital instead of city) birth location of a person, animal or fictional character."
        ]
    },
    "redfm_spouse": {
        "en": [
            "Spouse relation: the subject has the object as their spouse (husband, wife, partner, etc.)"
        ]
    },
    "redfm_citizenship": {
        "en": [
            "Country of Citizenship relation: the object is a country that recognizes the subject as its citizen."
        ]
    },
    "redfm_instanceof": {
        "en": [
            "Instance of relation: that class of which this subject is a particular example and member."
        ]
    },
    "redfm_capital": {
        "en": [
    ...
    "redfm_shareborderwith": {
        "en": [
            ...
            "item borders, either by land or water."
        ]
    },
    "redfm_author": {
        "en": [
            "Author relation: main creator(s) of a written work (use on works, not humans);\n"
...
EXAMPLES = {
    "redfm_cel": {"en": ["81P/Wild", "704 Interamnia", "Pallas", "Ceres"]},
    "redfm_concept": {
        "en": [
            "football",
    ...
    "redfm_date": {"en": ["December 4, 2019", "1901", "1607", "1777"]},
    "redfm_dis": {"en": ["potentially hazardous asteroid", "Cancer", "Gemini"]},
    "redfm_eve": {
        "en": [
            "World War II",
            "2022 Asian Games",
    ...
    "redfm_loc": {"en": ["Cusco", "Argentina", "Santiago do Cacém", "Odemira"]},
    "redfm_media": {"en": ["Lady Vengeance", "Sympathy for Mr. Vengeance"]},
    "redfm_misc": {"en": ["Meiko", "Vocaloid"]},
    "redfm_org": {"en": ["The CW", "ViacomCBS", "CBS Corporation"]},
    "redfm_per": {
        "en": [
    ...
    "redfm_time": {"en": ["Langhian", "Burdigalian", "Serravallian"]},
}
