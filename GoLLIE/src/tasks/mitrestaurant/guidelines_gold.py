GUIDELINES = {
    ...
    "mit_amenity": {
        "en": [
            ...
            " experience. It includes various expressions , such as accessibility options (handicapped accessible),"
    ...
    "mit_cuisine": {
        "en": [
            ...
            " tradition. It includes various types of cuisines, such as chinese, italian, mexican, fast food,"
            " seafood, etc."
        ]
    },
}
