GUIDELINES = {
    "time": {
        "en": [
            "A specific time of day, expressed using hours and optionally AM/PM or minutes."
        ]
    },
    "date": {
        "en": [
    ...
    "weather_descriptor": {
        "en": [
            "Words describing weather conditions, including precipitation, temperature, or cloud cover."
        ]
    },
    "player_setting": {
        "en": [
            "Settings or modes for a music player or audio device, controlling playback options."
        ]
    },
    "joke_type": {
    ...
    "event_name": {
        "en": [
            "Names of specific events or appointments, including meetings, birthdays, or appointments."
        ]
    },
    "business_type": {
        "en": [
            "Types of businesses or industries, used to categorize businesses or services."
        ]
    },
    "playlist_name": {
        "en": [
            "Names of playlists or collections of music, typically organized by genre, mood, or activity."
        ]
    },
    "music_descriptor": {
        "en": [
    ...
    "podcast_name": {
        "en": [
            "Names of podcasts or audio series, typically featuring discussions, interviews, or stories."
        ]
    },
    "audiobook_name": {
    ...
    "ingredient": {
        "en": [
            "Ingredients used in recipes or food preparation, specifying the specific food items or substances."
        ]
    },
    "game_name": {
    ...
    "podcast_descriptor": {
        "en": [
            "Phrases describing a specific episode or segment within a podcast, often used to reference the next or previous episode."
        ]
    },
    "movie_type": {
    ...
    "transport_agency": {
        "en": [
            "Names of transportation companies or services, providing transportation options like ride-sharing or taxis."
        ]
    },
    "transport_descriptor": {
        "en": [
            "Words or phrases describing the characteristics or specifics of a transport journey, such as the direction, class, or type of travel."
        ]
    },
    "transport_name": {
        "en": [
            "Names of specific transportation routes or services, including train lines, flights, or specific transportation vehicles."
        ]
    },
    "currency_name": {
        "en": [
            "Names of currencies used in financial transactions, specifying the type of currency."
        ]
    },
    "definition_word": {
    ...
    "email_folder": {
        "en": [
            "Names of folders or categories used to organize emails within an email account."
        ]
    },
    "game_type": {
        "en": [
