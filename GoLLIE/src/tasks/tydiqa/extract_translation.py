...
def get_tydiqa_hf(
    ...
    dataset = load_dataset(
        "tydiqa", "secondary_task", cache_dir="/coc/pskynet6/ychen3411/cache/"
    )
...
for lang in ["ar", "ru", "ko", "te", "fi", "id", "bn", "sw", "th"]:
    ...
    with open(
        f"/coc/pskynet6/ychen3411/transfusion/GoLLIE/data_translatetest/tydiqa/{lang}.jsonl",
        "w",
        encoding="utf-8",
    ) as f:
        for s in sentence:
    ...
    with open(
        f"/coc/pskynet6/ychen3411/transfusion/GoLLIE/data_translatetest/tydiqa/ques_{lang}.jsonl",
        "w",
        encoding="utf-8",
    ) as f:
        for q in question:
